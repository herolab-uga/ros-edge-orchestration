...
class Scheduler:
    ...
    def callback_nodes(self, msg):
        ...
        for node in self.nodes: 
            ...
            if (node == '/tb3_1/robot_state_publisher'):
                self.node_names.append('R1/robot_driver')
            elif (node == '/tb3_2/robot_state_publisher'):
                self.node_names.append('R2/robot_driver')
            elif (node == '/tb3_3/robot_state_publisher'):
                self.node_names.append('R3/robot_driver')

            # AMCL nodes
            elif (node =='/tb3_1/map_server'):
                self.node_names.append('R1/AMCL')
            elif (node =='/tb3_2/map_server'):
                self.node_names.append('R2/AMCL')
            elif (node == '/tb3_3/map_server'):
                self.node_names.append('R3/AMCL')
    ...
    def start(self):
        rospy.loginfo("Prescript started")
